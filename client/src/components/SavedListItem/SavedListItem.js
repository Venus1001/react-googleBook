        ...
        <div>
            <div className="card">
                ...
                <div className="card-body">
                    ...
                    <p style={{fontStyle: "italic"}}className="card-text" >{description}</p>
                    <p style={{fontStyle: "italic"}}>Author(s): {authors}</p>
                    <a href={link} target="_blank" rel="noopener noreferrer" className="btn" style={{marginRight: "6px", backgroundColor: "#000000", color: "white"}}>View Book</a>
